import { shallowRef, ref, toRef, computed, createVNode, withDirectives, vShow, watch, Fragment, resolveDirective, mergeProps, inject, provide, toRaw } from 'vue';
import { V as VDefaultsProvider, M as MaybeTransition, e as VExpandTransition, i as makeBorderProps, n as makeDensityProps, j as makeDimensionProps, c as makeElevationProps, m as makeRoundedProps, s as makeRouterProps, o as makeVariantProps, R as Ripple, v as useLink, k as useBorder, t as useVariant, p as useDensity, l as useDimension, u as useElevation, d as useRounded, w as genOverlays, b as VIcon } from './index-jw0wqd8u.mjs';
import { m as makeComponentProps, a as makeTagProps, u as useRender } from './tag-pIHjuosL.mjs';
import { ab as defineComponent, p as propsFactory, I as IconValue, g as genericComponent, S as EventProp, o as makeThemeProps, q as provideTheme, ac as deprecate, t as provideDefaults, w as useProxiedModel, f as getCurrentInstance, v as getUid, x as deepEqual, aa as focusChild, ad as getPropertyFromItem, W as omit } from '../server.mjs';
import { u as useSsrBoot } from './ssrBoot-xH9VG8QW.mjs';
import { c as createSimpleFunctional, a as VAvatar } from './VAvatar-Tkx6eOqd.mjs';
...
export { VList as V, VListItem as a, VListGroup as b, makeItemsProps as m, useItems as u };
//# sourceMappingURL=VList-0_bPAEAt.mjs.map
