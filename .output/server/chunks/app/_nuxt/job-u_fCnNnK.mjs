import { _ as __nuxt_component_1 } from './select-_AXsm2yX.mjs';
import __nuxt_component_1$1 from './Icon-c2IgCBiv.mjs';
import { V as VDialog, _ as __nuxt_component_2$1 } from './VDialog-JcAH9Fxa.mjs';
import { ref, computed, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, withModifiers, createCommentVNode, Fragment, renderList, isRef, useSSRContext, mergeModels, useModel, mergeProps } from 'vue';
...
import { u as useSkillStore } from './skills-gawPb64t.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const preview = ref((_a2 = isApplicant.value) != null ? _a2 : false);
    const formData = ref(null);
    const applicant = ref({
      userId: currentUser.value.userId,
      id: (_b2 = (_a = currentUser.value.applicant) == null ? void 0 : _a.applicantId) != null ? _b2 : 0,
      title: (_c2 = (_b = currentUser.value.applicant) == null ? void 0 : _b.title) != null ? _c2 : "",
      experience: (_d2 = (_c = currentUser.value.applicant) == null ? void 0 : _c.experience) != null ? _d2 : 0,
      experienceLevel: (_e2 = (_d = currentUser.value.applicant) == null ? void 0 : _d.experienceLevel) != null ? _e2 : "",
      location: (_f2 = (_e = currentUser.value.applicant) == null ? void 0 : _e.location) != null ? _f2 : "",
      documents: (_g2 = (_f = currentUser.value.applicant) == null ? void 0 : _f.documents) != null ? _g2 : [
        { name: "CV", value: null, title: null, file: null },
        { name: "Cover letter", value: null, title: null, file: null }
      ],
      skills: (_h = (_g = currentUser.value.applicant) == null ? void 0 : _g.skills) != null ? _h : []
    });
...
//# sourceMappingURL=job-u_fCnNnK.mjs.map
