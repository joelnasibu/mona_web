...
import { useSSRContext, withCtx, createVNode, mergeProps, unref, createTextVNode } from 'vue';
...
import { V as VFooter } from './VFooter-bKQd-Fpc.mjs';
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<p class="footer-bottom-text" data-v-dc52198c${_scopeId4}> \xA9 2025 Nairobi Markets. All rights reserved. Designed by <a href="https://mijinitech.com" target="_blank" class="footer-link" data-v-dc52198c${_scopeId4}>MijiniTech</a></p>`);
                            } else {
                              return [
                                createVNode("p", { class: "footer-bottom-text" }, [
                                  createTextVNode(" \xA9 2025 Nairobi Markets. All rights reserved. Designed by "),
                                  createVNode("a", {
...
//# sourceMappingURL=landing-page-zpJBvQRY.mjs.map
