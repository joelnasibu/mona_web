...
import { ref, watchEffect, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, useSSRContext, createTextVNode, withModifiers, openBlock, createBlock, Fragment, renderList, createCommentVNode } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VAvatar, {
              ...
              size: "50",
              class: "rounded-lg",
              image: (_a = __props.job.business.logo) != null ? _a : __props.job.banner
            ...
            if (!__props.minimal) {
              ...
              _push2(`<!--]--></div><div class="text-caption three-lines mt-2 text-grey-darken-1"${_scopeId}><span${_scopeId}>${(_b = __props.job.description) != null ? _b : ""}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "d-flex pa-3" }, [
                createVNode(VAvatar, {
                  ...
                  size: "50",
                  class: "rounded-lg",
                  image: (_c = __props.job.business.logo) != null ? _c : __props.job.banner
                }, null, 8, ["image"]),
...
//# sourceMappingURL=saved-jobs-y-pK1khe.mjs.map
