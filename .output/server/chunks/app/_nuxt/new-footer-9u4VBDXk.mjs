                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<p class="footer-bottom-text text-caption" data-v-4953f20c${_scopeId5}> \xA9 2025 Nairobi Markets. All rights reserved.<br data-v-4953f20c${_scopeId5}> Powered by <a href="https://mijinitech.com" target="_blank" class="footer-link" data-v-4953f20c${_scopeId5}>MijiniTech</a></p>`);
                                  } else {
                                    return [
                                      createVNode("p", { class: "footer-bottom-text text-caption" }, [
                                        createTextVNode(" \xA9 2025 Nairobi Markets. All rights reserved."),
                                        createVNode("br"),
...
//# sourceMappingURL=new-footer-9u4VBDXk.mjs.map
