import { createVNode, computed, withDirectives, vShow, ref, toRef, watch, mergeProps, Fragment, resolveDirective, cloneVNode, shallowRef, provide, inject, unref, nextTick } from 'vue';
import { b as VSlideYTransition, d as VExpandXTransition } from './index-d8gkbdU6.mjs';
import { m as makeComponentProps, u as useRender } from './tag-pIHjuosL.mjs';
import { m as makeTransitionProps, M as MaybeTransition, I as Intersect$1 } from './index-q-0zZOOG.mjs';
import { p as propsFactory, S as EventProp, o as makeThemeProps, g as genericComponent, y as wrapInArray, I as IconValue, e as useRtl, v as getUid, q as provideTheme, B as convertToUnit, w as useProxiedModel, $ as filterInputAttrs, E as useLocale, F as getCurrentInstanceName, A as consoleWarn, X as useToggleScope, Y as isOn, Z as pick, a0 as callEvent } from '../server.mjs';
import { m as makeDensityProps, u as useDensity, V as VIcon } from './index-3E7yy1qS.mjs';
import { u as useTextColor, a as useBackgroundColor } from './color-rZjm0Y7u.mjs';
import { b as makeLoaderProps, u as useLoader, L as LoaderSlot } from './position-AkaJaFJy.mjs';
...
export { Box as B, VTextField as V, VInput as a, makeFocusProps as b, VLabel as c, makeFormProps as d, createForm as e, forwardRefs as f, animate as g, deceleratedEasing as h, acceleratedEasing as i, getTargetBox as j, getOverflow as k, makeVFieldProps as l, makeVInputProps as m, nullifyTransforms as n, filterFieldProps as o, VField as p, VCounter as q, makeVTextFieldProps as r, standardEasing as s, useForm as t, useFocus as u };
//# sourceMappingURL=VTextField-8SU2p1Ep.mjs.map
