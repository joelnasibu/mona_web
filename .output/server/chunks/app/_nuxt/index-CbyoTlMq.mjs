...
import { computed, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, isRef, useSSRContext, resolveComponent } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const imageUrl = computed(() => {
      var _a;
      return (_a = props.image) != null ? _a : props.profile ? profileImage : placeholderImage;
    });
...
//# sourceMappingURL=index-CbyoTlMq.mjs.map
