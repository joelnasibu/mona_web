import { _ as __nuxt_component_0 } from './search-7NER10xK.mjs';
import { _ as __nuxt_component_1$1 } from './select-_AXsm2yX.mjs';
import { _ as __nuxt_component_0$1 } from './prices-9pvNrOLU.mjs';
import { s as storeToRefs, h as useAppStore, _ as _export_sfc, b as navigateTo, j as __nuxt_component_0$1$1 } from '../server.mjs';
import { ref, watchEffect, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, useSSRContext, withModifiers } from 'vue';
  ...
  navigateToProductDetails() {
    ...
    navigateTo({
      ...
      params: {
        ...
        id: (_a = this.product.productId) != null ? _a : this.product.objectID
      }
    });
  }
}
      ...
      _push(ssrRenderComponent(VCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div><div class="text-caption text-grey-darken-1 three-lines" data-v-19230c6d${_scopeId}><span data-v-19230c6d${_scopeId}>${(_a = `${String(__props.product.description).toLowerCase()}`) != null ? _a : ""}</span></div></div><div class="ml-auto" data-v-19230c6d${_scopeId}>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AdminCoreSearch = __nuxt_component_0;
...
//# sourceMappingURL=wishlist-wtJsDqzo.mjs.map
