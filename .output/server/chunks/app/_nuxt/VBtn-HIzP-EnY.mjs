import { toRef, createVNode, mergeProps, ref, computed, watchEffect, withDirectives, resolveDirective, provide, inject, watch, reactive, nextTick, unref } from 'vue';
import { i as makeBorderProps, n as makeDensityProps, c as makeElevationProps, m as makeRoundedProps, o as makeVariantProps, p as useDensity, k as useBorder, u as useElevation, d as useRounded, q as makeSizeProps, r as useSize, j as makeDimensionProps, s as makeRouterProps, R as Ripple, t as useVariant, l as useDimension, v as useLink, w as genOverlays, b as VIcon, V as VDefaultsProvider } from './index-jw0wqd8u.mjs';
import { m as makeComponentProps, a as makeTagProps, u as useRender } from './tag-pIHjuosL.mjs';
import { p as propsFactory, o as makeThemeProps, g as genericComponent, q as provideTheme, t as provideDefaults, B as convertToUnit, I as IconValue, f as getCurrentInstance, v as getUid, w as useProxiedModel, x as deepEqual, y as wrapInArray, z as findChildrenWithProvide, A as consoleWarn } from '../server.mjs';
import { d as useIntersectionObserver, e as makeLoaderProps, m as makeLocationProps, b as makePositionProps, u as useLoader, a as useLocation, c as usePosition } from './position-WfCzcf5A.mjs';
...
export { VBtn as V, VProgressCircular as a, useGroupItem as b, makeGroupProps as c, VBtnToggle as d, makeGroupItemProps as m, useGroup as u };
//# sourceMappingURL=VBtn-HIzP-EnY.mjs.map
