import { V as VCarousel, a as VCarouselItem, _ as _imports_0, b as __nuxt_component_0 } from './VCarouselItem-ELKWuvLF.mjs';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                                    ...
                                    ssrRenderList(unref(shuffledImages), (img) => {
                                      _push6(ssrRenderComponent(VCarouselItem, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<div class="w-100 h-100" data-v-07340d5d${_scopeId6}>`);
                  ...
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="w-100 h-100 d-flex flex-column justify-center pa-1 pa-md-5" data-v-07340d5d${_scopeId3}><div class="mt-auto" data-v-07340d5d${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ClientShopBusinessCreate, null, null, _parent4, _scopeId3));
                        _push4(`</div><div class="mt-auto" data-v-07340d5d${_scopeId3}>`);
                                    ...
                                    _push6(ssrRenderComponent(VCol, { cols: "12" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        ...
                                        if (_push7) {
                                          ...
                                          _push7(`<div class="d-flex justify-center ga-3 ga-md-10 text-caption" data-v-07340d5d${_scopeId6}>`);
                                          if (unref(redirect)) {
                                            _push7(ssrRenderComponent(_component_NuxtLink, {
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-07340d5d${_scopeId7}>Return</span>`);
                                                } else {
                                                  return [
                                          ...
                                          ssrRenderList(links, ({ title, route }) => {
                                            _push7(`<div class="" data-v-07340d5d${_scopeId6}>`);
                                            _push7(ssrRenderComponent(_component_NuxtLink, {
                                              to: route,
                                              class: "text-black"
                                            }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<span data-v-07340d5d${_scopeId7}>${ssrInterpolate(title)}</span>`);
                                                } else {
                                                  return [
...
const createBusinessAccount = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-07340d5d"]]);

export { createBusinessAccount as default };
//# sourceMappingURL=create-business-account-TsfK4uAi.mjs.map
