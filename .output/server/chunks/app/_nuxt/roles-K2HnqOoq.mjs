    ...
    async updateRole(body) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Role updated successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
    ...
    async deleteRole(id) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Role deleted successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
...
export { useRoleStore as u };
//# sourceMappingURL=roles-K2HnqOoq.mjs.map
