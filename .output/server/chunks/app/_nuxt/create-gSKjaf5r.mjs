...
import { u as useHelpers, a as useAuthStore, b as useHttp } from './useHelpers-kUuDaVs4.mjs';
import { ref, computed, withCtx, unref, createVNode, isRef, useSSRContext } from 'vue';
import { a as useSeoMeta } from './index-S1hhTCs3.mjs';
import { k as defineStore, s as storeToRefs, h as useAppStore, b as navigateTo } from '../server.mjs';
    ...
    async createRole(body) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Role created successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
...
//# sourceMappingURL=create-gSKjaf5r.mjs.map
