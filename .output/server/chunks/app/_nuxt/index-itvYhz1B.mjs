...
import { _ as __nuxt_component_1, a as __nuxt_component_2 } from './discussion-Y3-VC0ig.mjs';
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VCol, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_ChatRooms, { onToggleChat: toggleRoom }, null, _parent5, _scopeId4));
                              } else {
                                return [
                                  createVNode(_component_ChatRooms, { onToggleChat: toggleRoom })
                                ];
                              }
                            }),
                            _: 1
...
//# sourceMappingURL=index-itvYhz1B.mjs.map
