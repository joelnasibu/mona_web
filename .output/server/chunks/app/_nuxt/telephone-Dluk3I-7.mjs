    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VTextField, {
        ...
        "prepend-inner": withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="d-flex align-center justify-center append text-caption"${ssrRenderAttr("id", `country_${unref(handle_id)}`)} data-v-f4ecd46d${_scopeId}><span class="mx-2" data-v-f4ecd46d${_scopeId}>${ssrInterpolate((_a = getCountryCallingCode(unref(country))) != null ? _a : "+243")}</span>`);
...
//# sourceMappingURL=telephone-Dluk3I-7.mjs.map
