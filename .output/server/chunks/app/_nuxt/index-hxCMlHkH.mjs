import { _ as __nuxt_component_0$2 } from './page-header-zc_xglZV.mjs';
import { _ as __nuxt_component_0$3 } from './stepper-ipq6mb5U.mjs';
import { _ as __nuxt_component_0$1 } from './index-CbyoTlMq.mjs';
...
import { useSSRContext, shallowRef, ref, computed, watch, createVNode, inject, withDirectives, resolveDirective, vShow, mergeProps, Fragment, onUnmounted, withCtx, openBlock, createBlock, renderList, unref, toDisplayString, toRef, provide, isRef, watchEffect, createCommentVNode } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { p as propsFactory, g as genericComponent, w as useProxiedModel, ab as defineComponent, a3 as clamp, B as convertToUnit, e as useRtl, ay as SUPPORTS_EYE_DROPPER, az as HSVtoCSS, Q as parseColor, au as RGBtoHSV, aA as RGBtoCSS, x as deepEqual, aB as getContrast, W as omit, A as consoleWarn, t as provideDefaults, ap as getEventCoordinates, aq as HSVtoHex, ar as has, as as HSVtoRGB, at as HSVtoHSL, av as HSLtoHSV, ax as getDecimals, V as createRange, s as storeToRefs, h as useAppStore, aw as HexToHSV, b as navigateTo, _ as _export_sfc, ag as keyValues } from '../server.mjs';
import { u as useCategoryStore } from './categories-OjbYYiNy.mjs';
import { u as useSubcategoryStore } from './subcategories-bX2ZHLNb.mjs';
import { m as makeRoundedProps, c as makeElevationProps, R as Ripple, u as useElevation, a as VScaleTransition, d as useRounded, b as VIcon, e as VExpandTransition, f as VSlideYTransition } from './index-jw0wqd8u.mjs';
...
import { b as makeFocusProps, m as makeVInputProps, u as useFocus, a as VInput, c as VLabel, V as VTextField } from './VTextField-Q67PbqhP.mjs';
import { V as VBadge } from './VBadge-rQ5h9Gnj.mjs';
import { m as makeDelayProps, u as useDelay } from './VOverlay-NMZIuW_y.mjs';
...
import { u as useSizeStore } from './sizes-7RVjSyx-.mjs';
...
import { u as useTextColor, a as useBackgroundColor } from './color-52hqu1To.mjs';
import { m as makeVSheetProps, V as VSheet } from './VSheet-SPKhQ0zP.mjs';
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VBadge, {
                                content: (_a2 = __props.payload.stock) == null ? void 0 : _a2.length,
                                inline: "",
                                color: "link",
                                location: "end"
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<b class="mr-5"${_scopeId5}>Stock Details</b>`);
                                  } else {
                                    return [
                                      createVNode("b", { class: "mr-5" }, "Stock Details")
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              return [
                                createVNode(VBadge, {
                                  content: (_b = __props.payload.stock) == null ? void 0 : _b.length,
                                  inline: "",
                                  color: "link",
                                  location: "end"
                                }, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VDataTable, {
                                density: "compact",
                                headers,
                                items: __props.payload.stock,
                                class: "bg-background"
                              }, {
                                [`item.no`]: withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(__props.payload.stock.indexOf(item) + 1)}</span>`);
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(__props.payload.stock.indexOf(item) + 1), 1)
                                    ];
                                  }
                                }),
                                ...
                                [`item.expiration_date`]: withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(item.expiration_date ? unref(dateFormat_Month)(item.expiration_date) : "-")}</span>`);
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(item.expiration_date ? unref(dateFormat_Month)(item.expiration_date) : "-"), 1)
                                    ];
                                  }
                                }),
                                [`item.color`]: withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              return [
                                createVNode(VDataTable, {
                                  ...
                                  [`item.expiration_date`]: withCtx(({ item }) => [
                                    createVNode("span", null, toDisplayString(item.expiration_date ? unref(dateFormat_Month)(item.expiration_date) : "-"), 1)
                                  ]),
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getData = async () => {
      ...
      if (props.edit)
        props.payload.categoryId = (_a2 = categories.value.find((cat) => cat.category === props.payload.category)) == null ? void 0 : _a2.id;
    ...
    const setCategory = async (val) => {
      ...
      props.payload.categoryId = (_a2 = categories.value.find((cat) => cat.category === val)) == null ? void 0 : _a2.id;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-dea537fd>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="mx-auto d-flex flex-column align-center" data-v-dea537fd${_scopeId3}>`);
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(VCol, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div class="d-flex ga-2" data-v-dea537fd${_scopeId7}>`);
                                                _push8(ssrRenderComponent(VTextField, {
                                                  label: "Discount",
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              if (__props.payload.images.length > 0) {
                                _push5(`<div class="no-wrap overflow-x-auto w-100 hide-scrollbar" data-v-dea537fd${_scopeId4}>`);
                                _push5(ssrRenderComponent(VBadge, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="mr-5" data-v-dea537fd${_scopeId5}>Product Images</span>`);
                                    } else {
                                      return [
                                ...
                                _push5(`<div class="ga-2 mt-3 d-flex" data-v-dea537fd${_scopeId4}><!--[-->`);
                                ssrRenderList(__props.payload.images, (img, i) => {
                                  _push5(`<div class="position-relative" data-v-dea537fd${_scopeId4}>`);
                                  _push5(ssrRenderComponent(VHover, null, {
                                    default: withCtx(({ isHovering, props: props2 }, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`<div${ssrRenderAttrs(mergeProps({ class: "" }, { ref_for: true }, props2))} data-v-dea537fd${_scopeId5}>`);
                                        _push6(ssrRenderComponent(VCard, {
                                          width: "100",
                                                  ...
                                                  if (_push8) {
                                                    _push8(ssrRenderComponent(VExpandTransition, null, {
                                                      default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          if (isHovering) {
                                                            _push9(`<div class="d-flex text-caption cursor-pointer" style="${ssrRenderStyle({ "height": "100%", "background": "rgba(0, 0, 0, 0.3)" })}" title="Remove image" data-v-dea537fd${_scopeId8}>`);
                                          ...
                                          default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              if (isHovering && img !== __props.payload.thumbnail) {
                                                _push7(`<div class="text-caption text-center text-link cursor-pointer text-decoration-underline" data-v-dea537fd${_scopeId6}><span data-v-dea537fd${_scopeId6}>Set as thumbnail</span></div>`);
                                              } else {
                                                _push7(`<!---->`);
                                              }
                                            } else {
                                    ...
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        if (__props.payload.thumbnail === img) {
                                          _push6(`<div class="text-caption text-center" data-v-dea537fd${_scopeId5}><span data-v-dea537fd${_scopeId5}>Thumbnail</span>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-dea537fd"]]);
const _sfc_main$3 = {
  __name: "business",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const removeStock = async (item) => {
      if (edit.value)
        await deleteProductStock(stock.value);
      let i = props.payload.stock.indexOf(item);
      if (i > -1)
        props.payload.stock.splice(i, 1);
    };
    const headers = [
      { title: "#", value: "no" },
      { title: "Size", value: "size" },
    ...
    const moveNext = () => {
      let tab = 2;
      if (props.payload.stock.length > 0)
        tab = 3;
      else
        toggleSnackbar({
          status: true,
    ...
    return (_ctx, _push, _parent, _attrs) => {
                      ...
                      if (_push4) {
                        if (__props.edit) {
                          _push4(ssrRenderComponent(VCol, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="ga-2 mt-3 d-flex"${_scopeId4}><div class="mx-auto d-flex flex-column align-center"${_scopeId4}>`);
                                _push5(ssrRenderComponent(_component_AdminCoreImage, {
                                  onSetImage: setImage,
                                  image: unref(stock).image,
                                  profile: false,
                                  "full-size": true,
                                  editable: false
                        ...
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(VRow, { align: "start" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VTextField, {
                                            label: `Size(${unref(sizesList).length})`,
                                            modelValue: unref(stock).size,
                                            "onUpdate:modelValue": ($event) => unref(stock).size = $event,
                                            loading: unref(loadData),
                                            readonly: "",
                                            id: "selectSize",
                                            "append-inner-icon": "mdi-chevron-down"
                                          }, null, _parent7, _scopeId6));
                                          _push7(ssrRenderComponent(_component_AdminCoreSelect, {
                                            activator: "#selectSize",
                                            list: unref(sizesList),
                                            listValue: __props.payload.size,
                                            onSetItem: setSize
                                          }, null, _parent7, _scopeId6));
                                        } else {
                                          return [
                                            createVNode(VTextField, {
                                              ...
                                              id: "selectSize",
                                              "append-inner-icon": "mdi-chevron-down"
                                            }, null, 8, ["label", "modelValue", "onUpdate:modelValue", "loading"]),
                                            createVNode(_component_AdminCoreSelect, {
                                              activator: "#selectSize",
                                              list: unref(sizesList),
                                              listValue: __props.payload.size,
                                                  ...
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(ssrRenderComponent(VColorPicker, {
                                                        modelValue: unref(stock).color,
                                                        "onUpdate:modelValue": ($event) => unref(stock).color = $event,
                                                        mode: "hexa"
                                                      }, null, _parent9, _scopeId8));
                                                    } else {
                                                      return [
                                    ...
                                    _push6(ssrRenderComponent(VCol, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VTextField, {
                                            label: "Quantity",
                                            modelValue: unref(stock).stock,
                                            "onUpdate:modelValue": ($event) => unref(stock).stock = $event,
                                            modelModifiers: { number: true },
                                            rules: unref(required)(),
                                            onKeypress: unref(digitsOnly)
                                          }, null, _parent7, _scopeId6));
                                    ...
                                    _push6(ssrRenderComponent(VCol, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(VTextField, {
                                            label: "Price",
                                            modelValue: unref(stock).price,
                                            "onUpdate:modelValue": ($event) => unref(stock).price = $event,
                                            modelModifiers: { number: true },
                                            rules: unref(required)(),
                                            onKeypress: unref(digitsOnly),
                                            prefix: "USD"
                        ...
                        return [
                          __props.edit ? (openBlock(), createBlock(VCol, {
                            key: 0,
                            cols: "12",
                            sm: "4",
                            class: "text-caption"
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="w-100 d-flex justify-end ga-3"${_scopeId4}>`);
                              ...
                              _push5(ssrRenderComponent(VBtn, {
                                "prepend-icon": unref(edited) ? "mdi-content-save" : "mdi-plus",
                                flat: "",
                                color: "primary-accent",
                                class: "card-outlined text-caption text-none",
                                rounded: "lg",
                                size: "small",
                                onClick: handleStock,
                                loading: unref(loadData)
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span${_scopeId5}>${ssrInterpolate(unref(edited) ? "Update" : "Add")}</span>`);
                                  } else {
                                    return [
                                      createVNode("span", null, toDisplayString(unref(edited) ? "Update" : "Add"), 1)
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              return [
                                createVNode("div", { class: "w-100 d-flex justify-end ga-3" }, [
                                  createVNode(VBtn, {
                                    icon: "mdi-refresh",
                                    title: "Restaurer",
                                    variant: "text",
      ...
      _push(ssrRenderComponent(VDataTable, {
        density: "compact",
        headers,
        items: __props.edit ? unref(stocks) : __props.payload.stock,
        class: "bg-background mt-10",
        loading: unref(loadData)
      }, {
        [`item.no`]: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (item.image) {
              _push2(ssrRenderComponent(VAvatar, { size: "40" }, {
              ...
              _push2(`<span${_scopeId}>${ssrInterpolate(unref(stocks).indexOf(item) + 1)}</span>`);
            }
          } else {
            return [
              item.image ? (openBlock(), createBlock(VAvatar, {
                ...
                _: 2
              }, 1024)) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(unref(stocks).indexOf(item) + 1), 1))
            ];
          }
        }),
        [`item.price`]: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate(unref(currencyFormat)(item.price))}</span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(unref(currencyFormat)(item.price)), 1)
            ];
        ...
        [`item.expiration_date`]: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate(item.expiration_date ? unref(dateFormat_Month)(item.expiration_date) : "-")}</span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(item.expiration_date ? unref(dateFormat_Month)(item.expiration_date) : "-"), 1)
            ];
        ...
        [`item.color`]: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        [`item.action`]: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VBtn, {
              ...
              variant: "text",
              title: "Remove",
              onClick: ($event) => removeStock(item)
            }, null, _parent2, _scopeId));
          } else {
            return [
              __props.edit ? (openBlock(), createBlock(VBtn, {
                key: 0,
                icon: "mdi-pencil-outline",
                size: "small",
                variant: "text",
...
//# sourceMappingURL=index-hxCMlHkH.mjs.map
