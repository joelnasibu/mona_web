...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "" }, _attrs))} data-v-e945604d><div class="" data-v-e945604d>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e945604d"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-REqgoZDW.mjs.map
