  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        ":--3cc06416": iconUrl.value
      } };
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: sSize.value, height: sSize.value }
      }, _attrs, _cssVars))} data-v-479d4694></span>`);
    };
  }
});
...
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-479d4694"]]);

export { IconCSS as default };
//# sourceMappingURL=IconCSS-PvqPOovZ.mjs.map
