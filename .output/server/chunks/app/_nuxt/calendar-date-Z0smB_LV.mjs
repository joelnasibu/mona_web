import { computed, createVNode, ref, shallowRef, createTextVNode, watchEffect, mergeProps, toRef, watch, Fragment, useSSRContext, unref, isRef, withCtx } from 'vue';
...
import { g as genericComponent, p as propsFactory, T as useDate, w as useProxiedModel, V as createRange, B as convertToUnit, W as omit, E as useLocale, y as wrapInArray, S as EventProp, U as getWeek } from '../server.mjs';
import { u as useRender } from './tag-pIHjuosL.mjs';
import { a as useBackgroundColor } from './color-52hqu1To.mjs';
import { M as MaybeTransition, V as VDefaultsProvider, g as VFadeTransition, b as VIcon } from './index-jw0wqd8u.mjs';
    ...
    return () => createVNode("div", {
      ...
      return createVNode("div", {
        ...
        default: () => {
          var _a2;
          var _a;
          return [(_a2 = (_a = slots.day) == null ? void 0 : _a.call(slots, slotProps)) != null ? _a2 : createVNode(VBtn, slotProps.props, null)];
        }
      })]);
    })])]);
  }
...
//# sourceMappingURL=calendar-date-Z0smB_LV.mjs.map
