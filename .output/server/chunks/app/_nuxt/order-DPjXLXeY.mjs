    ...
    async createOrder(body) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Order created successfully!"
        });
      } catch (e) {
    ...
    async updateOrder(body) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Order updated successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
    ...
    async changeOrderStatus(body) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Order status updated successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
    ...
    async deleteOrder(order) {
      ...
      try {
        ...
        this.app.toggleSnackbar({
          status: true,
          type: "success",
          message: (_a = res.message) != null ? _a : "Order deleted successfully!"
        });
      } catch (e) {
        this.helpers.errorHandler(e);
      }
...
//# sourceMappingURL=order-DPjXLXeY.mjs.map
