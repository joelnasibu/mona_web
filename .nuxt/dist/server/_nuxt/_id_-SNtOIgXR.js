...
import { _ as _export_sfc, h as useAppStore, s as storeToRefs, l as useRoute, j as __nuxt_component_0 } from "../server.mjs";
import "hookable";
import "destr";
import "klona";
import "devalue";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    ref("");
    ref(0);
    ref(product.value.totalStock ?? 0);
    ref(0);
...
//# sourceMappingURL=_id_-SNtOIgXR.js.map
