import { ref, computed, mergeProps, unref, isRef, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext, createCommentVNode, watch } from "vue";
import "hookable";
import "destr";
import "klona";
import "devalue";
import "defu";
import { s as storeToRefs, h as useAppStore, m as useDevice, _ as _export_sfc } from "../server.mjs";
...
import { u as useChatStore, a as useSupabase } from "./chat-JPFHFeEL.js";
...
import { b as VExpandXTransition } from "./index-d8gkbdU6.js";
...
const _imports_0 = "" + __publicAssetsURL("logos/access-no-tag.png");
const _sfc_main$2 = {
  __name: "rooms",
...
const icon = "" + __buildAssetsURL("typing.n-4ih3Pr.gif");
const _sfc_main = {
  __name: "discussion",
  __ssrInlineRender: true,
  emits: ["closeChat"],
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              _push2(ssrRenderComponent(VImg, {
                src: ((_a2 = unref(receiver)) == null ? void 0 : _a2.picture) ?? ((_c = (_b = unref(chat)) == null ? void 0 : _b.product) == null ? void 0 : _c.thumbnail)
              }, null, _parent2, _scopeId));
            } else {
              return [
                createVNode(VImg, {
                  src: ((_d = unref(receiver)) == null ? void 0 : _d.picture) ?? ((_f = (_e = unref(chat)) == null ? void 0 : _e.product) == null ? void 0 : _f.thumbnail)
                }, null, 8, ["src"])
              ];
            }
          }),
...
//# sourceMappingURL=discussion-BR0DqQPD.js.map
