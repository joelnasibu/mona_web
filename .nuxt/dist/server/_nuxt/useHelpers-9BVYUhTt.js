import { h as useAppStore, k as defineStore, b as navigateTo } from "../server.mjs";
  ...
  const errorHandler = (e, show = true) => {
    ...
    if (show)
      app.toggleSnackbar({
        status: true,
        type: "error",
        message: ((_b = e.response) == null ? void 0 : _b._data.message) ?? e.message
      });
  };
  const routeNavigation = () => {
    var _a, _b;
    navigateTo({
      name: ((_a = app.redirect) == null ? void 0 : _a.name) ?? "index",
      params: ((_b = app.redirect) == null ? void 0 : _b.params) ?? {}
    });
  };
  const adminRouteNavigation = () => {
    var _a, _b;
    navigateTo({
      name: ((_a = app.adminRedirect) == null ? void 0 : _a.name) ?? "index",
      params: ((_b = app.adminRedirect) == null ? void 0 : _b.params) ?? {}
    });
  };
  return {
    numberFormat,
    ...
    dateDifference(date1, date2) {
      ...
      const date2InMs = new Date(date2 ?? /* @__PURE__ */ new Date()).getTime();
    ...
    timePassedSinceDate(date1, date2) {
      ...
      const end = new Date(date2 ?? /* @__PURE__ */ new Date());
      const timeElapsed = {
...
//# sourceMappingURL=useHelpers-9BVYUhTt.js.map
