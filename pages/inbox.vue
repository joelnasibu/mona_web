<template>
  <CoreMidScreenLayout :lg="10" :xl="9">
    <v-container :style="{ height: '92vh', width: '100vw' }" class="d-flex align-center">
      <v-row :style="{ height: `${isMobileOrTablet ? 100 : 90}%` }" v-if="mdAndUp && !isMobileOrTablet"
        ...
        <v-col xs="12" sm="12" md="5" lg="5" class="px-0 h-100 pb-0"
          ...
          <ChatRooms @toggleChat="toggleRoom" provider="client" />
      ...
      <v-window v-model="showDiscussion" v-else class=" h-100 w-100 ">
